...
import { BigDesc, Box, Button, Container, DisplayLg, Flex, Image, QuickLinkList, TitleLg, TitleMd } from '@/design-system'
import { AgencyData, SpotlightBlock, PageComponent, ServiceSectionBlock } from '@/types'
