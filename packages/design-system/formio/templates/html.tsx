...
import h from 'vhtml'
import type { HTMLElementSchema, ComponentContext, Override } from '../types'

export default { form }
export type HTMLElementContext = Override<
  ComponentContext<HTMLElementSchema>,
  {
    tag: string
    attrs: Array<{
      attr: string
 ...
 */
export function form(ctx: HTMLElementContext) {
