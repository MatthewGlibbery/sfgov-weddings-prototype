...
export default function NotFoundPage() {
  ...
  const links = [
    ...
    },
    {
      ...
      title: t('find-a-city-service', {
        defaultValue: 'Find a City service'
      })
    },
    {
    ...
    >
      <Container className="mx-0 md:mx-28 space-y-20 md:space-y-28 lg:space-y-40 mb-20 md:mb-28 lg:mb-40">
        <NotFoundHero
          ...
          image={{
            src: bridgeFog,
            alt: 'fog covering the Golden Gate, revealing the top of the Golden Gate Bridge with the Marin Headlands in the background',
            width: 612,
            height: 408
          }}
        />
