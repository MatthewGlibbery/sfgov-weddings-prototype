      ...
      >
        ...
        <ul className="list-none space-y-8 m-0 p-0">
          ...
          <li>
            ...
            <kbd className="border-1 p-2 rounded-2">Arrow</kbd> to move between
            visuals
          </li>
          <li>
            <kbd className="border-1 p-2 rounded-2">Control</kbd> +{' '}
            <kbd className="border-1 p-2 rounded-2">Right arrow</kbd> to enter a
            visual or filter
          </li>
          <li>
        ...
        <ul className="list-none space-y-8 m-0 p-0">
          <li>
            <kbd className="border-1 p-2 rounded-2">Tab</kbd> or{' '}
            <kbd className="border-1 p-2 rounded-2">Arrow</kbd> to move around a
            table or visual
          </li>
          <li>
            <kbd className="border-1 p-2 rounded-2">Enter</kbd> to select within
            a table or visual
          </li>
          <li>
            <kbd className="border-1 p-2 rounded-2">Spacebar</kbd> to select or
            deselect a filter
          </li>
        </ul>
      </div>
